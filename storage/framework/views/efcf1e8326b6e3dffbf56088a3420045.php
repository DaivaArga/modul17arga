        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo e(request()->is('employees*') ? 'active' : ''); ?>" href="<?php echo e(route('employees.index')); ?>">Employee List</a>
                    </li>
                </ul>
                <div class="dropdown">
...
<?php /**PATH E:\ITTS\Semester 3\PAW\PAWcode\laravel\modul7framework\resources\views/layouts/app.blade.php ENDPATH**/ ?>